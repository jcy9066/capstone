...
class ActionRecognizer:
    def __init__(self, device=None):
        ...
        pose_config = find_weight('weights/td-hm_ViTPose-huge*.py')
        pose_checkpoint = find_weight('weights/td-hm_ViTPose-huge*.pth')
        
        print("⏳ 로컬 환경에서 ST-GCN++ 모델을 적재합니다...")
        ...
        print("✅ ViTPose & ST-GCN++ 로컬 적재 및 스코프 분리 완료!")
