...
execute_process(
  COMMAND "/usr/bin/git" show-ref "2.3.0"
  WORKING_DIRECTORY "/home/dabom_user/dabom_capstone/raspberry/pico_w_sdk/build/_deps/picotool-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/dabom_user/dabom_capstone/raspberry/pico_w_sdk/build/_deps/picotool-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/dabom_user/dabom_capstone/raspberry/pico_w_sdk/build/_deps/picotool-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
